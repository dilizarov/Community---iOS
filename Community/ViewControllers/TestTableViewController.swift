...
class TestTableViewController: UITableViewController, PresentControllerDelegate, LeaveCommunityDelegate {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        self.tableView.frame = CGRectMake(0, 0, self.tableView.frame.width, UIScreen.mainScreen().bounds.height - self.tableView.frame.origin.y)
    }
...
//        super.viewDidLoad()
//        
//        names = ["wow", "waefa", "fweg", "gwagg", "lawwww", "fawgwag", "gwwgwgw", "glmaaa"]
//        
...
//        
//        cell.configureView(names[Int(arc4random_uniform(UInt32(names.count)))])
//        
//        return cell
//    }
}
