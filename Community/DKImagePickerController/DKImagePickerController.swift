 ...
 */
public class DKImagePickerController: UINavigationController, RSKImageCropViewControllerDelegate {
    ...
    /// The callback shoots back the cropped UIImage when finished cropping.
    public var didCropImage: ((image: UIImage) -> Void)?
    ...
    public convenience init() {
        ...
        rootVC.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .Done, target: self, action: "done")
        
        rootVC.navigationItem.rightBarButtonItem?.enabled = false
    ...
    public func imageCropViewController(controller: RSKImageCropViewController!, didCropImage croppedImage: UIImage!, usingCropRect cropRect: CGRect) {
        controller.dismissViewControllerAnimated(true, completion: {
            self.dismissViewControllerAnimated(true, completion: {
                if let didCropImage = self.didCropImage {
